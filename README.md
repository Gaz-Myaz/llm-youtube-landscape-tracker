...
- Optional structured extraction for transcript-backed topics, summaries, content types, and evidence through Google Gemini, OpenAI-compatible providers, or Anthropic.
